...
from _train_config import root
sys.path.insert(0, root)

from Notebooks.Support_Functions._config import train_csv_path, model_path,model_version, performance_logs
from Notebooks.Support_Functions._config import train_feature_name
from Notebooks.Support_Functions._log_functions import append_txt
from Notebooks.Support_Functions._pkl_functions import serialize_model
from Notebooks.Support_Functions._training_functions import reg_evaluate, train_model
...
def run_train():
    ...
    append_txt(performance_logs, ','.join(map(str, valdation_metrics)))
